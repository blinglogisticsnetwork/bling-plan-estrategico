...
function ReportApp(){
  ...
  const printAll=(mode)=>{setExporting(true);setPrintMode(mode)}
  ...
  useEffect(()=>{
    ...
    const t=setTimeout(()=>{
      ...
      html2pdf().set({
        margin:10,
        filename:`Bling-Plan-Estrategico-${planYear}-${label}.pdf`,
        image:{type:'jpeg',quality:0.98},
        html2canvas:{scale:2,useCORS:true,backgroundColor:printMode==='executive'?'#ffffff':'#0A0F1E'},
        jsPDF:{unit:'mm',format:'a4',orientation:'portrait'},
        pagebreak:{mode:['css','avoid-all']}
      }).from(el).save().finally(()=>{setPrintMode(null);setExporting(false)})
    },300)
